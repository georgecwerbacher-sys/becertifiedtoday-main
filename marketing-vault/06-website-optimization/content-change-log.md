...
| 2026-06-03 | `/comptia-sec+-home.html`, `secplus-lead-capture.js` | Hero: 700+ bank, adaptive/sim/mobile pillars; sample CTAs secondary; funnel order intro→sim→samples→purchase; sticky upgrade after free sim consumed | Message match — large library + pass-before-work buyers | secplus_portal | no | |
| 2026-06-03 | `marketing-vault/10-competitors/` | PDF dump competitive analysis (16 entries), deep dive, Numbers/CSV tracker, per-site notes | Position vs dump sites — not course comps | strategy | n/a | |
| 2026-06-03 | `/comptia-sec+-home.html` | PDF/VCE comparison table + competitor-informed FAQ; compare block after samples, before purchase | Proof → compare → price funnel | secplus_portal | no | |
