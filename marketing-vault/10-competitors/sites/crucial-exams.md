...
Large paid bank; free tier limited. **Auto-poll off** until a sample URL with static HTML is confirmed. Paste manual rows or set `sample_url` + `enabled: true` when ready.
