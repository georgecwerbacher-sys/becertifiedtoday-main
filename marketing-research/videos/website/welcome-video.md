...
| **0:20** | 30 | **Problem** | A-roll · cut to B-roll every 5 s | Most prep still pushes the wrong choices: a **static dump**, a **desktop sim you install**, or a **$300 course** when you already know the material and just need to know — **am I ready?** | `Dump · Desktop sim · $300 course` | Quick montage: PDF icon · old sim · course thumbnail *(stock)* | Envato: `developer frustrated laptop` 2 clips |
...
| **2:05** | 25 | **Who / not + outro CTA** | A-roll → end card | For you if you are **weeks from test day** or your job **requires the cert**. **Not** a course — learn the material first, then **practice here**. Link below — pick your track. **Practice Like Test Day. Walk In Ready.** Thanks for watching. | End card URL | Logo end card 5 s | Envato minimal end card · recolor blue |
