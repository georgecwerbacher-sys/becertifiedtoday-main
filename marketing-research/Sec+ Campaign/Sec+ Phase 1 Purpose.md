...
New site · **6–12 months without a profit target.** Prove **Sec+ paid acquisition** with **data-driven, high-intent keywords** that convert. Accept **break-even or a small controlled loss** while learning. **Do not** scale products or large multi-campaign budgets until the Sec+ loop is **stable**.

**Why Sec+ first:** Strong need, PBQ + timed-sim wedge, less direct competition with CCNA/ENCOR course vendors.

---

## Monthly scorecard (all-in)
...
### Revenue includes (all-in)

- **Stripe** Sec+ sales (live)
- **PayPal** Sec+ sales (when live)
- **Organic** Sec+ sales (Reddit, forums, direct, SEO, word of mouth)

Organic revenue **counts toward the $500/month income side** of the scorecard. Strong organic can **fund more paid spend** without raising the cash loss cap.
...
## Stable (end Phase 1 · expand products)
...
- Begin **other products** and **larger campaigns** in planning
- Fold **non-marketing expenditures** into the same monthly accountability (hosting, tools, etc.)
- Organic marketing (**Reddit, forums**, etc.) continues in parallel; its sales still count all-in

**Phase 1 does not end on a fixed calendar date** — it ends when **stable** is met.

---

## Scope rules (until stable)
...
## Conversion-first stack (confirmed)
...
Numeric gates: [[Sec+ Phase 1 Scorecard]] — **confirmed 2026-06-24**.
