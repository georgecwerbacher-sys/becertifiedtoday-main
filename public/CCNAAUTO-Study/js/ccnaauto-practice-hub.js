(function () {
  ...
  window.CCNAAUTO_PRACTICE.SLUGS = [
    ...
    "private-cloud-on-prem-self-service-scale",
    "http-400-client-error-bad-request",
    "vlan-network-segmentation-broadcast-domain-choose-two",
    "git-add-readme-staging",
    "dns-client-query-types-choose-two",
    "default-gateway-forward-different-subnets",
    "edge-computing-low-latency-use-case",
    "json-network-object-host-value-access",
    "rest-api-success-status-code-200",
    "tdd-write-tests-before-code",
    "infrastructure-as-code-principles-choose-two",
    "rest-api-basic-auth-header-request",
    "ios-xe-configuration-change-protocols-choose-two",
    "owasp-cross-site-scripting-url-exhibit",
    "bash-rm-rf-delete-directory-recursive",
    "model-driven-infrastructure-automation-benefit",
    "cisco-dna-center-organization-wide-automation-wired-wireless",
    "json-python-tuple-represented-as-array",
    "json-xml-functionality-comparison",
    "load-balancer-modern-application-deployment",
