(function () {
  ...
  window.SECPLUS_PRACTICE.SLUGS = [
    ...
    "least-privilege-service-accounts-minimum-permissions",
    "wifi-deauthentication-attack-unsolicited-disconnects",
    "bcp-dr-role-matrix-backup-delegation-triggers",
    "mdm-work-container-data-separation-byod",
    "security-assessment-report-not-best-practices",
    "ransomware-edr-isolate-workstation-payroll-continuity",
    "incident-communication-internal-external-spokesperson",
    "data-classification-public-open-distribution",
    "pki-incorrect-statements-private-key-self-signed",
    "hospital-infusion-pumps-vlan-segmentation",
    "threat-intel-feeds-corroborate-ioc-confidence",
    "siem-alert-most-incorrect-false-positive-dismissal",
    "usb-evidence-chain-of-custody-avoid-actions",
    "siem-filter-user-account-all-log-sources",
    "web-app-assessment-monthly-scan-annual-pentest",
    "linux-web-server-investigation-access-auth-logs",
    "office-security-cameras-deterrent-physical-control",
    "annual-security-awareness-training-administrative-preventive",
    "firewall-restrictive-proxy-compensating-control",
    "siem-unusual-login-detective-technical-control",
    "malware-restore-backup-corrective-control",
    "perimeter-hids-endpoint-defense-in-depth",
    "background-check-new-hires-managerial-control",
    "honeypot-vulnerable-database-detective-control",
    "hospital-encrypt-patient-records-confidentiality",
    "wire-transfer-checksum-signature-integrity",
    "ecommerce-redundant-servers-availability",
    "data-modified-in-transit-integrity-compromised",
    "ransomware-file-server-confidentiality-availability",
    "dlp-block-ssn-email-confidentiality",
    "root-access-all-three-cia-triad",
    "database-wal-integrity-recovery",
    "vpn-password-authenticator-2fa",
    "kerberos-kdc-tickets-sso",
    "fingerprint-scan-something-you-are-factor",
    "financial-transaction-separation-of-duties",
    "tacacs-plus-aaa-encrypts-entire-packet-body",
    "zero-trust-continuous-adaptive-risk-device-health",
    "apt-defense-contractor-nation-state-actor",
    "hacktivist-website-defacement-environmental-protest",
    "script-kiddie-free-exploit-tool-teenager",
    "insider-threat-logic-bomb-disgruntled-administrator",
    "organized-crime-raas-affiliate-platform",
    "xss-malicious-script-url-html-output",
    "sqli-or-1-equals-1-login-form",
    "csrf-hidden-form-banking-fund-transfer",
    "buffer-overflow-stack-return-address-c-program",
    "privilege-escalation-sudo-misconfiguration-linux",
    "directory-traversal-etc-passwd-path-parameter",
    "replay-attack-kerberos-ticket-intercept",
    "ransomware-cryptocurrency-decryption-key-demand",
    "trojan-horse-pdf-reader-backdoor",
    "rootkit-kernel-system-calls-hide-av",
    "worm-smb-self-replicate-no-user-interaction",
    "logic-bomb-payroll-ad-removal-trigger",
    "polymorphism-malware-signature-changes",
    "phishing-fake-it-password-reset-login",
    "whaling-cfo-linkedin-conference-email",
    "vishing-pretexting-help-desk-executive-reset",
    "smishing-bank-suspicious-activity-text",
    "tailgating-secure-door-badge-piggybacking",
    "watering-hole-industry-news-website",
    "phishing-urgency-account-suspended-24-hours",
    "misconfiguration-default-admin-credentials-web-server",
    "ddos-botnet-flood-web-server-unavailable",
    "on-path-mitm-public-wifi-intercept",
    "dns-poisoning-banking-a-record-redirect",
    "arp-poisoning-default-gateway-mac-spoof",
    "brute-force-six-character-password-exhaust",
    "rainbow-table-password-hash-recovery",
    "credential-stuffing-breach-banking-email",
    "evil-twin-coffee-shop-ssid-capture",
    "deauthentication-wpa-handshake-offline-crack",
    "supply-chain-library-backdoor-dev-pipeline",
    "zero-day-os-vulnerability-no-patch",
    "unpatched-known-openssl-cve-delayed-patching",
    "misconfiguration-apache-directory-listing-enabled",
    "vuln-scan-false-positive-no-software-installed",
    "pretexting-tailgating-new-employee-door",
    "authority-urgency-fake-browser-security-update",
    "password-spraying-common-passwords-many-accounts",
    "toctou-permission-check-privileged-action",
    "dmz-public-web-servers-between-firewalls",
    "des-56-bit-key-insecure-symmetric",
    "vlan-accounting-engineering-departments",
    "stateful-inspection-firewall-state-table",
    "waf-blocks-sqli-xss-http-https",
    "ids-alerts-only-upgrade-to-ips",
    "forward-proxy-outbound-content-filtering-logging",
    "load-balancer-distribute-web-traffic-backends",
    "vpn-remote-employees-encrypted-tunnel",
    "microsegmentation-lateral-movement-workload-policies",
    "ngfw-application-awareness-ips-threat-intelligence",
    "paas-provider-manages-runtime-customer-apps",
    "iaas-customer-os-patching-access-control",
    "casb-users-cloud-policy-monitoring-dlp",
    "sase-sdwan-casb-fwaas-ztna-cloud-delivered",
    "cspm-cloud-config-misconfiguration-monitoring",
    "iaas-customer-controls-os-middleware-apps",
    "multicloud-centralized-kms-customer-managed-keys",
    "private-cloud-dedicated-resources-control-customization",
    "aes-advanced-encryption-standard-symmetric",
    "rsa-ecc-asymmetric-encryption",
    "sha256-hash-file-integrity-fingerprint",
    "software-release-digital-signature-non-repudiation",
    "diffie-hellman-shared-secret-insecure-channel",
    "md5-unsalted-password-hash-rainbow-table",
    "tls13-full-handshake-one-round-trip",
    "pki-certificate-authority-issues-signs-certificates",
    "wildcard-certificate-multiple-subdomains",
    "ev-certificate-green-address-bar-organization-name",
    "ocsp-real-time-certificate-revocation-check",
    "san-certificate-multiple-unrelated-domains",
    "pki-registration-authority-identity-verification",
    "network-segmentation-tier-firewalls-data-center",
    "client-side-encryption-customer-managed-keys-cloud",
    "diffie-hellman-key-exchange-insecure-channel",
    "intermediate-ca-certificate-chain-trust-verification",
    "siem-failed-logins-single-ip-brute-force",
    "siem-event-correlation-rules-alerts",
    "windows-event-4624-successful-logon",
    "systemd-journalctl-sshd-follow-auth-logs",
    "soar-automated-incident-response-playbooks",
    "syslog-tls-tcp-6514-encrypted-forwarding",
    "siem-false-positives-alert-fatigue",
    "siem-ioc-sweeping-malicious-ip-matching",
    "soar-edr-playbook-automatic-endpoint-isolation",
    "linux-sshd-failed-password-syslog-auth-facility",
    "siem-exfiltration-firewall-flow-proxy-logs",
    "svchost-unusual-port-living-off-the-land",
    "incident-response-preparation-before-ransomware",
    "incident-response-containment-prevent-spread",
    ...
    "nist-sp-800-53-federal-control-families",
    "nist-csf-five-core-functions",
    "iso-27001-isms-global-certification",
    "retail-credit-card-pci-dss-cardholder-data",
    "hospital-ephi-hipaa-security-controls",
    "public-company-sox-internal-controls-financial-reporting",
    "gdpr-right-erasure-deletion-personal-data",
    "university-student-records-ferpa-privacy",
    "multinational-data-sovereignty-border-storage",
    "cis-controls-prioritized-practical-starting-point",
    "soc2-type-ii-trust-services-controls-effectiveness",
    "cobit-it-governance-business-alignment",
    "ccpa-opt-out-sale-personal-information",
    "employee-salary-confidential-data-classification",
    "data-owner-classification-access-controls",
    "it-administrator-data-custodian-technical-controls",
    "healthcare-patient-records-phi-classification",
    "ssd-financial-records-cryptographic-erasure-destruction",
    "gdpr-data-controller-purposes-means-processing",
    "production-test-data-masking-fictitious-values",
    "employee-computer-internet-acceptable-use-policy",
    "lock-screen-clean-desk-sensitive-documents-policy",
    "simulated-phishing-susceptibility-awareness-training",
    "cloud-provider-vendor-assessment-third-party-risk",
    "mssp-sla-response-time-uptime-requirements",
    "supply-chain-sbom-dependency-vulnerability-monitoring",
    "pentest-rules-of-engagement-scope-document",
    "pentest-black-box-zero-knowledge-external",
    "phishing-response-reset-credentials-revoke-sessions",
    "service-account-least-privilege-read-folder-only",
    "lost-laptop-full-disk-encryption-powered-off"
  ];
