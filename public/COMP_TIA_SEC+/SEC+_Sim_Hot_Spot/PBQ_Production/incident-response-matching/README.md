...
**SY0-701 PBQ · NIST SP 800-61**

Twelve incident response actions sorted into six NIST IR phase buckets (two actions per phase).

## Section

| File | Part |
|------|------|
| `sections/incident-response-matching.html` | Action bank + phase buckets |
...
```text
http://localhost:3000/COMP_TIA_SEC+/SEC+_Sim_Hot_Spot/PBQ_Production/incident-response-matching/incident-response-matching.html
```
