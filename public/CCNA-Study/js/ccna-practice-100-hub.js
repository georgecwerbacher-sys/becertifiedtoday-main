(function () {
  ...
  function bankSlugs(bankId) {
    ...
    if (bankId === "2") return all.slice(100);
    return all.slice(0, 100);
  }

  function start(mode, bankId) {
    bankId = bankId || "1";
  ...
  function bindHub() {
    document.querySelectorAll("[data-ccna100]").forEach(function (el) {
      el.addEventListener("click", function () {
        ...
        if (m === "random" || m === "review") start(m, bank);
      });
    });
  }
