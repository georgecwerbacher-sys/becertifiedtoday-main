/**
 * CCNP ENCOR home — Google Ads `encor_portal_10d` landing (`utm_content=portal-10d`).
...
(function () {
  ...
  function applyPurchaseVariant() {
    var defaultBlock = document.getElementById("encorPurchaseDefault");
    var tenDayBlock = document.getElementById("encorPurchase10d");
  ...
  if (isPortal10dLanding()) {
    document.documentElement.classList.add("encor-landing-portal-10d");
  }
  ...
  window.bccIsEncorPortal10dLanding = isPortal10dLanding;
